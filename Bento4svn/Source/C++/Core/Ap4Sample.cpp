...
|   AP4_Sample::AP4_Sample
+---------------------------------------------------------------------*/
//AP4_Sample::AP4_Sample(bool isfakesample,
//					   AP4_DataBuffer* data_stream,
//                       AP4_Position    offset,
//                       AP4_Size        size,
//                       AP4_Ordinal     description_index,
//                       AP4_UI64        dts,
...
//    m_IsSync(is_sync)
//{
//    //m_DataStream = new AP4_MemoryByteStream((AP4_DataBuffer)data_stream);
//	m_DataStream->Write(data_stream, size);
//
//}
/*----------------------------------------------------------------------
|   AP4_Sample::AP4_Sample
