...
#ifndef _AP4_SYNTHETIC_SAMPLE_TABLE2_H_
#define _AP4_SYNTHETIC_SAMPLE_TABLE2_H_
...
|   constants
+---------------------------------------------------------------------*/
const AP4_Cardinal AP4_SYNTHETIC_SAMPLE_TABLE2_DEFAULT_CHUNK_SIZE = 10;

/*----------------------------------------------------------------------
|   AP4_SyntheticSampleTable
+---------------------------------------------------------------------*/
class AP4_SyntheticSampleTable2 : public AP4_SampleTable
{
 public:
    // methods
             AP4_SyntheticSampleTable2(AP4_ByteStream* data);
    virtual ~AP4_SyntheticSampleTable2();
...
private:
	...
	AP4_ByteStream*					  m_FileStorage;
};

#endif // _AP4_SYNTHETIC_SAMPLE_TABLE2_H_
